<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"C:\phpStudy\WWW\robot\public/../application/index\view\news\industry.html";i:1654158130;s:61:"C:\phpStudy\WWW\robot\application\index\view\Common\head.html";i:1654081211;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\header.html";i:1572830715;s:62:"C:\phpStudy\WWW\robot\application\index\view\Common\layer.html";i:1564031755;s:65:"C:\phpStudy\WWW\robot\application\index\view\Common\layerbox.html";i:1565250812;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\footer.html";i:1654081168;}*/ ?>
        ...
        <div class="newslistimg">
            <ul>
                <?php if(is_array($indiamge) || $indiamge instanceof \think\Collection || $indiamge instanceof \think\Paginator): $i = 0; $__LIST__ = $indiamge;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$indiamge): $mod = ($i % 2 );++$i;?>
                    <li>
                        <a href="<?php echo url('news/indusarticle',array('id'=>$indiamge['id'])); ?>">
                            <div class="pic">
                    ...
                    <td class="newslisttb">
                        ...
                        <div class="tbdiv">
                            ...
                            <a href="<?php echo url('news/article',array('id'=>$industry['id'])); ?>">
                                <p class="title"> <?php echo mb_substr($industry['title'] ,0,60,'utf-8'); ?></p>
                                <p class="summary"> <?php echo $industry['summary']; ?></p>
                            </a>
                        </div>
                    </td>
                    <!-- <td class="center">少儿编程</td> -->

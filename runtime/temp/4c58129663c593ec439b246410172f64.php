...
<div class="contentWidth navbar">
    ...
    <div class="swiper-container swiper-container-index">
        <div class="swiper-wrapper">
            ...
            <img src="/static/index/images/page3m.png" alt="">
            </div>
            <div class="swiper-slide"> <img src="/static/index/images/page3m.png" alt=""></div>
        </div>
        <!-- Add Pagination -->
        <div class="swiper-pagination" id="bannerpagination"></div>
    </div>
    <div class="contentWidth am-padding-bottom-xs">
    ...
    <div class="pic_w am-padding-bottom-xs">

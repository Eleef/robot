<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"C:\phpStudy\WWW\robot\public/../application/admin\view\news\index.html";i:1572937807;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\head.html";i:1562654678;s:63:"C:\phpStudy\WWW\robot\application\admin\view\Common\header.html";i:1572940490;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\left.html";i:1583829996;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="portlet-title">
					...
					<div class="actions">
						<ul class="actions-btn">
							<a href="news/add"><button type="button" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-plus"></span> 添加</button></a>
						</ul>
					</div>
				</div>
										...
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a href="<?php echo url('admin/news/edit',array('id'=>$industry['id'])); ?>"
														class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
															class="am-icon-pencil-square-o"></span> 编辑</a>
													<a href="<?php echo url('admin/news/del',array('id'=>$industry['id'])); ?>"

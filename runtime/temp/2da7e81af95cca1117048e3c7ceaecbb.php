<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"C:\phpStudy\WWW\robot\public/../application/admin\view\banner\add.html";i:1616743458;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\head.html";i:1562654678;s:63:"C:\phpStudy\WWW\robot\application\admin\view\Common\header.html";i:1572940490;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\left.html";i:1583829996;}*/ ?>
<!doctype html>
<html>
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>添加轮播图
                    </div>
                </div>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="" enctype="multipart/form-data"
                                method="post">

                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">Banner</label>
                                    <div class="am-u-sm-9 ">
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                                <i class="am-icon-cloud-upload"></i> 添加Banner</button>

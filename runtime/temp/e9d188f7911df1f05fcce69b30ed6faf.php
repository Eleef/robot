<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"C:\phpStudy\WWW\robot\public/../application/index\view\news\index.html";i:1654158284;s:61:"C:\phpStudy\WWW\robot\application\index\view\Common\head.html";i:1654081211;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\header.html";i:1572830715;s:62:"C:\phpStudy\WWW\robot\application\index\view\Common\layer.html";i:1564031755;s:65:"C:\phpStudy\WWW\robot\application\index\view\Common\layerbox.html";i:1565250812;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\footer.html";i:1654081168;}*/ ?>
<!DOCTYPE html>
<html lang="en">
﻿<head>
  <meta charset="UTF-8">
...
<div class="contentWidth navbar">
    ...
    <div class="swiper-container swiper-container-index">
        <div class="swiper-wrapper">
            <div class="indexbanner minw swiper-slide"> <img src="/robot/public/static/index/images/20190819114158.jpg" alt=""></div>
            <div class="indexbanner minw swiper-slide">
                <img src="/robot/public/static/index/images/20190819114158.jpg" alt="">
            </div>
        </div>
        <!-- Add Pagination -->
    ...
    <div class="contentWidth">
        ...
        <div class="newslistimg">
            <ul>
                ...
                <li>
                    <a href="<?php echo url('news/article',array('id'=>$indiamge['id'])); ?>">
                        <div class="pic">
                            <img src="/robot/public/upload/<?php echo $indiamge['image']; ?>" />
                        </div>
                        <div class="text">
                            <p><?php echo $indiamge['title']; ?></p>
                        </div>
                    </a>
                </li>
                ...
                <tr>
                    <td class="newslisttb">
                        <div class="tbdiv">
                            ...
                            <a href="<?php echo url('news/article',array('id'=>$industry['id'])); ?>">
                                <p class="title"> <?php echo mb_substr($industry['title'] ,0,60,'utf-8'); ?></p>   </a>
                                <p class="summary"> <?php echo $industry['summary']; ?></p>
                         
                        </div>
                    </td>
                    <td class="t_right"><?php echo date("Y-m-d",$industry['time']); ?></td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </table>
            <?php echo $page; ?>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"C:\phpStudy\WWW\robot\public/../application/admin\view\news\edit.html";i:1616746392;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\head.html";i:1562654678;s:63:"C:\phpStudy\WWW\robot\application\admin\view\Common\header.html";i:1572940490;s:61:"C:\phpStudy\WWW\robot\application\admin\view\Common\left.html";i:1583829996;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
          ...
          <div class="am-g">
            <div class="tpl-form-body tpl-form-line">
              <form class="am-form tpl-form-line-form" action="" enctype="multipart/form-data" method="post">
                <input type="hidden" name="img"  value="<?php echo $industry['image']; ?>"/>
                <div class="am-form-group">
                  <label for="user-name" class="am-u-sm-3 am-form-label">标题<span
                      class="tpl-form-line-small-title">Title</span></label>
                  <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" id="user-name" name="title" value="<?php echo $industry['title']; ?>">
                ...
                <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" name="description" value="<?php echo $industry['description']; ?>">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <input type="text" class="tpl-form-input" name="summary" value="<?php echo $industry['summary']; ?>">
                ...
                <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9 yulan">
                    <div class="pic">
                      ...
                      <?php else: ?>
                      <img src="/upload/<?php echo $industry['image']; ?>" class="img" />
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                    <textarea id="content" rows="5" name="content"><?php echo $industry['content']; ?></textarea>
                  </div>
                </div>

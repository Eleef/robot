<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"C:\phpStudy\WWW\robot\public/../application/index\view\competition\zhjn.html";i:1576546264;s:61:"C:\phpStudy\WWW\robot\application\index\view\Common\head.html";i:1572830715;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\header.html";i:1572830715;s:62:"C:\phpStudy\WWW\robot\application\index\view\Common\layer.html";i:1564031755;s:65:"C:\phpStudy\WWW\robot\application\index\view\Common\layerbox.html";i:1565250812;s:63:"C:\phpStudy\WWW\robot\application\index\view\Common\footer.html";i:1642214281;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ﻿
<head>
    ...
    <div class="contentWidth clearfix">
        ...
        <div class="am-tabs competition_tab" data-am-tabs>
            <ul class="am-nav am-nav-tabs">
                ...
                <li class="am-active"><a href="/competition/zhjn">综合技能</a></li>
                ...
                <div class="am-tab-panel am-active">
                    ...
                    <div class="competition_content am-margin-bottom">
                        <div class="am-padding-vertical-sm clearfix center">
                            <a href="https://www.bilibili.com/video/av51725344?from=search&seid=13436421650334664084"
                                target="_blank">
                                <img src="/static/index/images/zhjn.jpg" />
                                <p class="am-margin-top-sm">点击图片可查看视频介绍</p>
                            </a>
                        </div>
                        <div class="am-margin-vertical-xs am-padding-top-xs">
                            机器人综合技能比赛是中国青少年机器人竞赛项目之一，其活动对象为中小学生。在一块固定的场地上设置数个不同难度的任务，要求比赛的代表队在现场自行拼装机器人、编制机器人运行程序、调试和操作机器人。在中国青少年机器人竞赛中设置机器人综合技能比赛的目的是检验青少年对机器人技术的理解和掌握程度，激发我国青少年对机器人技术的兴趣，培养动手、动脑的能力。
                        </div>
                    </div>
                    ...
                    <div class="competition_content m-margin-bottom">
                    ...
                    <div class="widthimg contentWidth">
                        <img src="/static/index/images/in7.png">
                    </div>
                    <div class="center tuijian_title am-margin-bottom-lg">
                        <h1>海客机器人综合技能教练团队</h1>
                    </div>
                    <div class="widthimg contentWidth am-padding-top">
                        <img src="/static/index/images/zhjn_ter.jpg" />
                    </div>
                    <div class="competition_content m-margin-bottom">
                        <div class="am-margin-vertical-lg">
                            海客机器人综合技能教练团队目前共有金牌教练2人，海客拥有顶级的机器人综合技能教练，在科协组织的国家级、省级比赛均斩获大奖，在2018年综合技能项目获得广东省小学组冠军，晋级国赛获得全国二等奖。
                        </div>
                    </div>
                    <div class="center tuijian_title am-margin-bottom-xl">
                        <h1>机器人综合技能部分教学成果</h1>
                    </div>
                    <div class="widthimg contentWidth">
                        <img src="/static/index/images/03_07.png" class="pic">
                    </div>
                </div>
            </div>
        </div>
        <div class="row competition_bottom">
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_03.png" />
            </div>
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_05.png" />
            </div>
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_07.png" />
            </div>
        </div>
        <div class="row competition_bottom">
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_12.png" />
            </div>
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_13.png" />
            </div>
            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-u-xs-12">
                <img src="/static/index/images/20190817133525_15.png" />
            </div>
        </div>
    </div>
    <!-- 悬浮条 -->
